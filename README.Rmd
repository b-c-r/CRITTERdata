...
Find example pictures of the habitat complexity levels 1 to 4 in pictogram style in the folder `pictures`. The original pictures were taken by Lorea Flores and published in @FloresEtAl2016HabitatComplexityAquatic, figure 1. Mireia Aranbarri and Ioar de Guzmán created the pictograms from these pictures.
